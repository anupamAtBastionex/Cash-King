<?php
    ...
    $date = date("Y-m-d");
    $image = (!empty($image))? $image : "https://bastionex.net/static/media/BrandLogo.3e69396cc2c94cfc8524.png";
     $no = mysqli_query($link,"INSERT INTO notifications SET title='$title',message='$message', date='$date', image='$image'");
...
//print_r($response);die;
$edata = json_decode($response, true);
//print_r($edata);die;
if(!empty($edata['errors']))
{
    $msg =  $edata['errors'][0];
}else{
